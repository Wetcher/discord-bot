...
class CommandsHandler {
    ...
    registerApplicationCommands = async (development, restOptions = null) => {
		...
		// rest.put(Routes.applicationGuildCommands(this.client.user.id, development.guildId), { body: [] })
        ...
        if (development.enabled) {
			...
			console.log(this.client.rest_application_commands_array);
            let asd = await rest.put(Routes.applicationCommands(this.client.user.id), { body: this.client.rest_application_commands_array });
			console.log(asd);
        }
    }
}
